...
public extension INNPOP where Base: UIControl {
...
fileprivate extension UIControl  {
    ...
    private var hitTime: Double? {
        get { return inn_getAssociatedObject(self, &hitTimerKey) }
        set { inn_setRetainedAssociatedObject(self, &hitTimerKey, newValue, .OBJC_ASSOCIATION_ASSIGN) }
    }
    ...
    @objc func c_preventDoubleHit(_ base: UIControl)  {
        ...
        INNAsyncs.asyncDelay(hitTime ?? 1.0) {
        } _: {
